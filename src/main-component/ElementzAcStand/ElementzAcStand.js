...
import ElementzSections from '../../components/ElementzSections/ElementzSections';
            ...
            <div className="blog-sidebar">
                ...
                <div className="widget category-widget">
                    ...
                    <ul>
                            ...
                            <li> Heavy duty wall mount bracket stand</li>
                            <li>High quality automotive grade weatherproof coating</li>
                            <li> Anti rut resistant shield for longevity</li>
                            <li> Suitable for 0.8 to 3.0 ton units</li>
                    </ul>
                </div>
                <div className="widget category-widget">
                <h3>TYPES OF STAND</h3>
                    <ul>
                       
                    <li> Metal with powder coating</li>
...
export default ElementzAcStand;
